...
export const ENGLISH_110_QUESTIONS: Question[] = Array.from({ length: 41 }, (_, i) => {
  ...
  return {
    ...
    imagePath: `${import.meta.env.BASE_URL}questions/english/110/q${padded}.png`,
    explanationImagePath: `${import.meta.env.BASE_URL}explanations/english/110/e${padded}.png`,
