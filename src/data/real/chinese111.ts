...
export const CHINESE_111_QUESTIONS: Question[] = Array.from({ length: 42 }, (_, i) => {
  ...
  return {
    ...
    imagePath: `${import.meta.env.BASE_URL}questions/chinese/111/q${padded}.png`,
    explanationImagePath: `${import.meta.env.BASE_URL}explanations/chinese/111/e${padded}.png`,
