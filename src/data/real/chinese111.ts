...
// 111年國中教育會考 國文科 選擇題 42 題 -- 由 tools/build_bank.py + tools/gen_ts.py
// 自動產生，請勿手動修改。題目、詳解截圖與正解皆取自 111會考國文解析.pdf。
...
export const CHINESE_111_QUESTIONS: Question[] = Array.from({ length: 42 }, (_, i) => {
  ...
  return {
    ...
    year: 111,
    qNo,
    groupId: g ? `國文-111-g${g[0]}-${g[1]}` : undefined,
    imagePath: `${import.meta.env.BASE_URL}questions/chinese/111/q${pad(g ? g[0] : qNo)}.png`,
    explanationImagePath: `${import.meta.env.BASE_URL}explanations/chinese/111/e${pad(qNo)}.png`,
