...
export const CHINESE_112_QUESTIONS: Question[] = Array.from({ length: 42 }, (_, i) => {
  ...
  return {
    ...
    imagePath: `${import.meta.env.BASE_URL}questions/chinese/112/q${padded}.png`,
    explanationImagePath: `${import.meta.env.BASE_URL}explanations/chinese/112/e${padded}.png`,
