...
export const SOCIAL_110_QUESTIONS: Question[] = Array.from({ length: 63 }, (_, i) => {
  ...
  return {
    ...
    imagePath: `${import.meta.env.BASE_URL}questions/social/110/q${padded}.png`,
    explanationImagePath: `${import.meta.env.BASE_URL}explanations/social/110/e${padded}.png`,
