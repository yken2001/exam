...
export const SCIENCE_112_QUESTIONS: Question[] = Array.from({ length: 50 }, (_, i) => {
  ...
  return {
    ...
    imagePath: `${import.meta.env.BASE_URL}questions/science/112/q${padded}.png`,
    explanationImagePath: `${import.meta.env.BASE_URL}explanations/science/112/e${padded}.png`,
