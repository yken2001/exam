...
// 111年國中教育會考 社會科 (54題)
// 題目截圖來源：111會考社會題本.pdf（乾淨無正解）
// 詳解截圖 + 正解字母來源：111會考社會解析.pdf（翰林出版）
...
function groupIdFor(qNo: number): string | undefined {
  ...
  return g ? `社會-111-g${g[0]}-${g[1]}` : undefined;
}
...
export const SOCIAL_111_QUESTIONS: Question[] = Array.from({ length: 54 }, (_, i) => {
  ...
  return {
    ...
    imagePath: `${import.meta.env.BASE_URL}questions/social/111/q${padded}.png`,
    explanationImagePath: `${import.meta.env.BASE_URL}explanations/social/111/e${padded}.png`,
