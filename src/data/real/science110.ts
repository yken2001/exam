...
// 110年國中教育會考 自然科 選擇題 54 題 -- 由 tools/build_bank.py + tools/gen_ts.py
// 自動產生，請勿手動修改。題目、詳解截圖與正解皆取自 110會考自然解析.pdf。
// 版權屬原出版社所有，僅供個人練習使用，不可公開散布。
const ANSWERS: Record<number, string> = {
  1: 'A', 2: 'D', 3: 'C', 4: 'D', 5: 'D', 6: 'C', 7: 'A', 8: 'B', 9: 'B', 10: 'A',
...
export const SCIENCE_110_QUESTIONS: Question[] = Array.from({ length: 54 }, (_, i) => {
  ...
  return {
    ...
    year: 110,
    qNo,
    groupId: g ? `自然-110-g${g[0]}-${g[1]}` : undefined,
    imagePath: `${import.meta.env.BASE_URL}questions/science/110/q${pad(g ? g[0] : qNo)}.png`,
    explanationImagePath: `${import.meta.env.BASE_URL}explanations/science/110/e${pad(qNo)}.png`,
